...
public class Ex2 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(cave.simulateFalling());
        //System.out.println(cave);
    }
    ...
    static class Cave extends Grid2d<CaveEle> {
        ...
        public void produceSand() {
            ...
            this.add(SAND_ORIGIN, currentlyFalling);
            ++producedSand;
        }

        public int simulateFalling() {
            while(!(hasEleAt(SAND_ORIGIN) && hasEleAt(SAND_ORIGIN.inDir(Dir2d.UP))))
                fallStep();
            return producedSand;
        }
