...
public class Ex1 {
    public static void main(String[] args) throws Exception {
        ...
        long res = elfPairs.stream()
                .filter(RangePair::isOneInsideOther)
                .count();
    ...
    static class RangePair {
        ...
        public boolean isOneInsideOther() {
            return range1.insideOther(range2) || range2.insideOther(range1);
        }
    ...
    static class Range {
        ...
        public boolean insideOther(Range other) {
