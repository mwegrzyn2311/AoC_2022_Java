...
import static day17.Ex1.TetrisRockType.*;
...
public class Ex1 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(cave.simulateHeightAfterSomeRocks(100));
    }
    ...
    static class TetrisCave {
        ...
        public int simulateHeightAfterSomeRocks(int rocks) {
        ...
        private void spawnNewRock() {
            curr = new TetrisRock(rockTypesSeq.get(rocksFallen % rockTypesSeq.size()), new Vec2d(0, maxHeight() + NEW_ROCK_Y_OFFSET));
        ...
        private Dir2d nextPush() {
            return pushSeq.get((currPush++) % pushSeq.size());
        }
